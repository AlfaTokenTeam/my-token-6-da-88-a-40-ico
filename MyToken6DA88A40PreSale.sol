...
import "./MyToken6DA88A40.sol";

contract MyToken6DA88A40PreSale {
    MyToken6DA88A40 public token;
    ...
    function MyToken6DA88A40PreSale(
        MyToken6DA88A40 _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyToken6DA88A40(_token);
